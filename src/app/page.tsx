                ...
                <div className='flex flex-col w-full p-[30px] gap-[30px] sm:gap-[50px] sm:p-[50px]'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-[16px]'>
                        <Link href={'https://disquiet.io/@sspzoa'} target='_blank' rel="noreferrer"
                              className=' w-full bg-grayscale-100 p-[20px] rounded-[16px] flex justify-center items-center ease-in-out duration-500 hover:-translate-y-[8px]'>
                            <Disquiet/>
                        </Link>
                        <Link href={'https://velog.io/@sspzoa/posts'} target='_blank' rel="noreferrer"
                              className='w-full bg-grayscale-100 p-[20px] rounded-[16px] flex flex-row gap-[12px] justify-center items-center ease-in-out duration-500 hover:-translate-y-[8px]'>
                            <Velog/>
