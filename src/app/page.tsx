                    ...
                    <div className='w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px]'>
                        ...
                        <div className='flex flex-row p-[15px] w-full gap-[12px] items-center'>
                            ...
                            <div className='flex flex-col gap-[2px]'>
                                ...
                                <p className='text-itemDescription text-grayscale-800'>교내 무인매점 결제 솔루션, 디미페이</p>
                            </div>
                        </div>
                    </div>
                    <div className='w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px]'>
        ...
        <>
            <div className='flex flex-col gap-[10px] w-full'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-[16px]'>
                    ...
                    <div
                        className='flex flex-row p-[20px] w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px] gap-[12px] items-center'>
                        <Image src={'/icons/silver-medal.png'} alt='dimigoin' width={44} height={44}
                               className='rounded-full'/>
                        <div className='flex flex-col gap-[2px]'>
                            <h1 className='text-itemTitle text-grayscale-800'>Junction Asia 2023 Finalist</h1>
                            <p className='text-itemDescription text-grayscale-800'>Finalist</p>
                        </div>
                    </div>
                    <div
                        className='flex flex-row p-[20px] w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px] gap-[12px] items-center'>
