...
function Info() {
    return (
        <>
            <div className='flex-shrink-0 h-[100vh] p-[75px] flex flex-col gap-[50px] bg-grayscale-100'>
                <div className='flex flex-col gap-[8px]'>
                    <Image className='rounded-full' src={'/images/sspzoa_logo.svg'} alt='sspzoa' width={184}
                           height={184}/>
                    <h1 className='text-[44px] font-[600] text-grayscale-1000'>
                        Seungpyo Suh
                    </h1>
                    <p className='text-header2 text-grayscale-800'>
                ...
                <div className='flex flex-col gap-[16px]'>
                    ...
                    <div className='flex flex-row gap-[24px]'>
                        <Image src={'/images/skills/flutter.svg'} alt='flutter' width={36} height={36}/>
                        <Image src={'/images/skills/android.svg'} alt='android' width={36} height={36}/>
                        <Image src={'/images/skills/react.svg'} alt='react' width={36} height={36}/>
                        <Image src={'/images/skills/nest.svg'} alt='nest' width={36} height={36}/>
                    </div>
                </div>
                <div className='flex flex-col gap-[16px]'>
                    <h1 className='text-itemTitle text-grayscale-600'>About</h1>
                    <div className='flex flex-col gap-[8px]'>
                        <p className='text-itemDescription text-grayscale-800'>2024.03~ | 디미고 인트라넷 개발팀, DIN Project
                            Manager</p>
                        <p className='text-itemDescription text-grayscale-800'>2023.11~ | 교내 무인매점 결제 솔루션 개발팀, 디미페이 App
                            Developer</p>
                        <p className='text-itemDescription text-grayscale-800'>2023.03~2026.01 | 한국디지털미디어고등학교 해킹방어과
                            22기</p>
                    </div>
                </div>
                <div className='flex flex-col gap-[16px]'>
...
function Projects() {
    return (
        <>
            <div className='flex flex-col px-[75px] pt-[75px] gap-[16px] w-full'>
                ...
                <div className='grid grid-cols-2 gap-[16px]'>
                    <div className='w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px]'>
                        ...
                        <div className='flex flex-row p-[20px] w-full gap-[12px] items-center'>
                            <img src='https://assets.isamin.kr/project/dimigoin.webp' alt='dimigoin'
                                 className='w-[52px] h-[52px] rounded-[16px]'/>
                            <div className='flex flex-col gap-[8px]'>
                                <h1 className='text-header2 text-grayscale-800'>디미고인</h1>
                                <p className='text-description text-grayscale-800'>한국디지털미디어고등학교 인트라넷</p>
                            </div>
                        </div>
                    </div>
                    <div className='w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px]'>
                        ...
                        <div className='flex flex-row p-[20px] w-full gap-[12px] items-center'>
                            ...
                            <div className='flex flex-col gap-[8px]'>
                                <h1 className='text-header2 text-grayscale-800'>디미페이</h1>
                                <p className='text-description text-grayscale-800'>한국디지털미디어고 결제 핀테크 서비스, 디미페이</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div
                    className='text-readable text-grayscale-100 rounded-full px-[12px] py-[6px] bg-grayscale-500 m-auto'>
                    더보기
                </div>
            </div>
        </>
...
function Awards() {
    return (
        <>
            <div className='flex flex-col p-[75px] gap-[16px] w-full'>
                ...
                <div className='grid grid-cols-2 gap-[16px]'>
                    <div
                        ...
                        <Image src={'/icons/gold-medal.png'} alt='dimigoin' width={52} height={52}
                               className='rounded-full'/>
                        <div className='flex flex-col gap-[8px]'>
                            <h1 className='text-header2 text-grayscale-800'>제5회 한국코드페어해커톤 금상</h1>
                            <p className='text-description text-grayscale-800'>과학기술정보통신부장관상</p>
                        </div>
                    </div>
                    <div
                        className='flex flex-row p-[20px] w-full bg-grayscale-100 border-grayscale-300 border-[1px] rounded-[16px] gap-[12px] items-center'>
                        <Image src={'/icons/bronze-medal.png'} alt='dimigoin' width={52} height={52}
                               className='rounded-full'/>
                        <div className='flex flex-col gap-[8px]'>
                            <h1 className='text-header2 text-grayscale-800'>2023 STA+C 가작</h1>
                            <p className='text-description text-grayscale-800'>SK플래닛대표상</p>
                        </div>
                    </div>
                </div>
                <div
